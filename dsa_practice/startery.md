...
tree traversal algos: inorder, preorder, postorder, levelorder
graph algos: DFS/BFS, Topological sort
...
order to learn dsa topics:- 

Arrays -> LinkedLists -> Stacks & Queues, -> Hash Tables -> Two Pointers/ Slideing Window -> Recurssion / Backtracking -> Sorting -> Searching -> Bit Manupulation -> Tree/BST/Trie -> Heaps -> Greedy -> Dynamic Programming -> Graphs/Union Find

tips: 
think in patterns
two pointers, sliding windows etc
